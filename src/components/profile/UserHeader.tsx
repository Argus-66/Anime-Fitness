...
export default function UserHeader({ user, isEditing, setIsEditing, onLogout }: UserHeaderProps) {
  ...
  return (
    <div className="flex justify-between items-start">
      <div className="flex items-center space-x-4">
        ...
        <div>
          ...
          <p className="text-solo-light">
            ...
            Height: {user.details?.height || 0}cm • 
            Weight: {user.details?.weight || 0}kg
          </p>
      ...
      <div className="flex space-x-4">
        ...
        <button onClick={onLogout} className="flex items-center space-x-2 px-4 py-2 rounded-lg bg-red-500/20 text-red-400 hover:bg-red-500/30">
